...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 01, 2019 at 12:45 PM
...
CREATE TABLE `bill` (
  ...
  `user_code` text CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE `cart` (
  ...
  `product_code` text CHARACTER SET utf8 NOT NULL,
  `volume` text CHARACTER SET utf8 NOT NULL,
  `user_code` text CHARACTER SET utf8 NOT NULL,
  `create_date` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `product` (
  ...
  `product_brand` text CHARACTER SET utf8 NOT NULL,
  `product_size` text CHARACTER SET utf8 NOT NULL,
  `product_volume` text CHARACTER SET utf8 NOT NULL,
  `product_price` text CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE `user` (
  ...
  `plain_password` text CHARACTER SET utf8 NOT NULL,
  `create_date` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
